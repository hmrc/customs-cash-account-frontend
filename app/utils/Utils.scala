...
import views.html.components.{h1, h1Inner, h2, h2Inner, link, newTabLink, notification_panel, p, dlComponent}
...
object Utils {
  ...
  def dlComponent(dtMsg: String, ddMsg: String, id: Option[String] = None, classes: String = "govuk-caption-xl")(
